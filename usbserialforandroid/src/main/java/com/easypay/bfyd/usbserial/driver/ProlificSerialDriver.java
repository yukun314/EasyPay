...
package com.easypay.bfyd.usbserial.driver;
...
public class ProlificSerialDriver implements UsbSerialDriver {
    ...
    class ProlificSerialPort extends CommonUsbSerialPort {
        ...
        private final void outControlTransfer(int requestType, int request,
            ...
            System.out.println("mConnection is null:"+(mConnection == null));
            int result = mConnection.controlTransfer(requestType, request, value,
        ...
        public void open(UsbDeviceConnection connection) throws IOException {
            System.out.println("ProlificSerialDriver open1");
            if (mConnection != null) {
            ...
            if (!connection.claimInterface(usbInterface, true)) {
                System.out.println("ProlificSerialDriver open2");
                throw new IOException("Error claiming Prolific interface 0");
            }
            System.out.println("ProlificSerialDriver open3");
            mConnection = connection;
            System.out.println("ProlificSerialDriver open  mConnection is null:"+(mConnection == null));
